              ...
              try {
                ...
                if (this.currentLang === 'fa') {
                  ...
                  if (daysRemaining > 0) {
                    ...
                    return `امروز آخرین روز (${persianDate})`;
                  } else {
                  ...
                  if (daysRemaining > 0) {
                    ...
                    return `Last day today (${englishDate})`;
                  } else {
  ...
  <body>
    ...
    <div class="container my-container" x-data="app" x-cloak>
      ...
      <div class="row row-cols-2 row-cols-md-4 g-3 mb-4">
        ...
        <div class="col">
          ...
          expireDate: '{{ user.expire_date }}'
            ...
            <p class="text-truncate my-text-content mb-0" x-text="getExpireText(expireStrategy, expireDate)">
            </p>
          </div>
        </div>
      ...
      <h3 class="my-text-heading mb-4 fw-bold d-flex align-items-center gap-2"
        :class="currentLang === 'fa' ? 'text-start' : 'text-end'" style="font-size: 1.5rem; letter-spacing: -0.5px;">
        <svg class="bi" style="width: 1.2em; height: 1.2em;">
          ...
          <div class="row g-3">
            <div class="col-12 col-lg-6">
              <div class="my-block-big h-100">
                ...
                <h5 class="my-text-heading fw-semibold" x-text="translations[currentLang].downloadApps">
                </h5>
            ...
            <div class="col-12 col-lg-6">
              <div class="equal-height-container">
                ...
                <div class="my-block-big">
                  ...
                  <p class="my-text-content mb-2" x-text="translations[currentLang].connectAndUseDesc">
                  </p>
                </div>
              </div>
            </div>
